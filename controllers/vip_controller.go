...
func GetUserVIPStatus(c *gin.Context) {
	...
	// ✅ Response format giống GetProfile
	c.JSON(http.StatusOK, gin.H{
		"is_vip":         isVIP,           // ✅ Đồng bộ với GetProfile
		"vip_expires_at": user.VIPExpires, // ✅ Đồng bộ với GetProfile
...
func CheckPodcastVIPRequirement(c *gin.Context) {
	...
	// ✅ Kiểm tra VIP còn hạn
	userIsVIP := user.VIP && user.VIPExpires != nil && user.VIPExpires.After(time.Now())
